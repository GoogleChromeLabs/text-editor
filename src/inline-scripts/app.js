...
app.saveFileAs = async () => {
  ...
  try {
    const text = 'getEncodedText' in app
      ? app.getEncodedText()
      : app.getText();
...
// it wouldn't be fun to check whether or not this is even a Map, before using .has and/or .get
app.supportedEncodings = new Map();
